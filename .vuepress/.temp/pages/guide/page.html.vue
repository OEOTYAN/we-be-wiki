...
<ul>
<li>
<p>Please use the relative link <code v-pre>./</code> for pictures in source directory.</p>
</li>
<li>
<p>For pictures in <code v-pre>.vuepress/public</code> directory, please use absolute link <code v-pre>/</code> for reference</p>
</li>
</ul>
</div>
